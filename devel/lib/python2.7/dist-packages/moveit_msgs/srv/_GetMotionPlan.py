...
class GetMotionPlanRequest(genpy.Message):
  _md5sum = "f7523150916abf9386dc8490831c71f5"
...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if python3:
        ...
        buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_struct_i2d.pack(_x.motion_plan_request.num_planning_attempts, _x.motion_plan_request.allowed_planning_time, _x.motion_plan_request.max_velocity_scaling_factor))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.motion_plan_request.num_planning_attempts, _x.motion_plan_request.allowed_planning_time, _x.motion_plan_request.max_velocity_scaling_factor,) = _struct_i2d.unpack(str[start:end])
      return self
...
class GetMotionPlan(object):
  ...
  _md5sum = '838cce25b2e64abc57c0c12ca2b6eae6'
