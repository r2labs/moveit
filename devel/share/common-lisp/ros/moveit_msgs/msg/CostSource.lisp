...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<CostSource>)))
  ...
  (cl:format cl:nil "# The density of the cost source~%float64 cost_density~%~%# The volume of the cost source is represented as an~%# axis-aligned bounding box (AABB)~%# The AABB is specified by two of its opposite corners~%~%geometry_msgs/Vector3 aabb_min~%~%geometry_msgs/Vector3 aabb_max~%~%================================================================================~%MSG: geometry_msgs/Vector3~%# This represents a vector in free space. ~%~%float64 x~%float64 y~%float64 z~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'CostSource)))
  "Returns full string definition for message of type 'CostSource"
  (cl:format cl:nil "# The density of the cost source~%float64 cost_density~%~%# The volume of the cost source is represented as an~%# axis-aligned bounding box (AABB)~%# The AABB is specified by two of its opposite corners~%~%geometry_msgs/Vector3 aabb_min~%~%geometry_msgs/Vector3 aabb_max~%~%================================================================================~%MSG: geometry_msgs/Vector3~%# This represents a vector in free space. ~%~%float64 x~%float64 y~%float64 z~%~%"))
